<%-- 
    Document   : searchMyBlog
    Created on : Nov 5, 2021, 10:57:19 PM
    Author     : ADMIN
--%>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark" >
                ...
                <div id="navigation" class="collapse navbar-collapse flex-column" >
                    <div class="profile-section pt-3 pt-lg-0">		
                        <c:if test="${sessionScope.account != null}">
                            <div class="bio mb-3">Hi, my name is ${sessionScope.account.user.displayName}.</div><!--//bio-->
                            </c:if>
                            <c:if test="${sessionScope.account == null}">
                    ...
                    <ul class="navbar-nav flex-column text-start">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="myList?id=${sessionScope.account.user.id}"><i class="fas fa-bookmark fa-fw me-2"></i>My Post</a>
                        </li>
                        <c:if test="${sessionScope.account != null && sessionScope.account.user.id != requestScope.user.id}">


                            <li class="nav-item">
                                <a class="nav-link" href="insertBlog"><i class="fas fa-plus fa-fw me-2"></i> New Blog <span class="sr-only"></span></a>
                            </li>
        ...
        <!--        <script>
                                        function doPrev(pageindex, id) {
                                            if (pageindex > 1) {
                                                pageindex -= 1;
                                                window.location.href = "searchMyBlog?id=" + id + "&page=" + pageindex;
                                            }
                                        }
